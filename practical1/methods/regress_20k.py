...
def regressLasso(features, gaps, x):	
	print "# Preparing Lasso..."

	LAS = Lasso(alpha = x, fit_intercept = True)

	print "# Lasso ready!\n"
	print "# Starting cross validation..."

	result = stupidcrossval(LAS, features, gaps)
	print "# The cross validation with alpha = {} gave the following results:".format(x)
...
if __name__ == "__main__":
	...
	with open('../features/20000/20000-train-morgan-256.csv', 'r') as features_set:
	...
	regressLasso(features, gaps, 100)
