...
likely_syscalls = ['dump_line', 'sleep', 'load_dll', 'vm_protect', 'open_key', 'query_value', 'create_file', 'get_file_attributes',
    'com_create_instance', 'open_file', 'find_file', 'enum_processes', 'create_mutex', 'set_windows_hook']
...
priors = ['3.69', '1.62', '1.2', '1.03', '1.33', '1.26', '1.72', '1.33', '52.14', '0.68', '17.56', '1.04', '12.18', '1.91', '1.30']
